# GoreeCloud Home Security — Feature Roadmap

**Status:** Active roadmap control  
**As of:** 2026-09-08  
**Authoritative project record:** Project Specification — Home Security  
**Canonical repository:** GoreeCloud/goreecloud-home-security
**Drive control:** `GoreeCloud/Feature Roadmap/GoreeCloud Home Security/FEATURE-ROADMAP.docx`

## Purpose

This file is the repository-side feature roadmap control for GoreeCloud Home Security. It records current planned and recommended feature work without replacing the authoritative project record, implementation evidence, release gates, or GoreeCloud Tasks Management.

## Roadmap

| ID | Feature / obligation | Priority | Current state |
| --- | --- | --- | --- |
| FR-001 | Reconcile and maintain every current planned or recommended GoreeCloud Home Security feature from the authoritative project record and verified repository evidence in this roadmap. | High | Ongoing control |
